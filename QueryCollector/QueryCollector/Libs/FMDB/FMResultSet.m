...
@synthesize columnsLowerCaseActivate=_columnsLowerCaseActivate;
...
- (NSDate*)dateForColumn:(NSString*)columnName
{
    ...
    NSDate *date = [formatter dateFromString:
                    [ self stringForColumn: columnName ]];
    
    return date;
}

- (NSDate*)dateNoFormatForColumn:(NSString*)columnName
{
